 ...
 * Time: 02:43 PM
 */
package course.dataTypes.primitives;
...
public class DataTypesInJava {
    public static void main(String[] args) {
        ...
        // range for char
        System.out.println("Character Range of char is from '" + Character.MIN_VALUE + "' to '" + Character.MAX_VALUE + "'");
        System.out.println("ASCII Range of char is from '" + (int) Character.MIN_VALUE + "' to '" + (int) Character.MAX_VALUE + "'");
